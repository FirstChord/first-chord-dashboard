...
export const WORKFLOW_DIRECTORY_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'Newsletter',
        description: 'Ask tutors for news, track what arrives and choose what to include.',
      },
      {
        href: '/admin/showcase',
        title: 'Showcase',
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/admin/lessons',
        title: 'Lesson Calendar & Data Checks',
        description: 'View the verified read-only week and investigate MMS mirror exceptions.',
      },
    ],
  },
];
