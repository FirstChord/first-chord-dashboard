...
export function classifyIssue(flagType) {
  ...
  if (type === 'LESSON DURATION MISMATCH') {
    return {
      ...
      recommendedAction: 'Decide which duration is right, then correct the wrong side — the Students sheet cell, the MMS calendar booking, or the MMS billing profile. Do not assume the sheet is stale: the forecast prices from the MMS calendar.',
