...
export function validatePayrollReview({ existing, expectedUpdatedAt = '', preview, expectedAmount, lessonCount, teachingMinutes }) {
  ...
  if (!preview || preview.reviewPastCount || preview.overlapsPaid || preview.overlapsOutstanding || preview.priorRunPending || preview.periodOpen || !preview.cadenceDue || preview.cutoverNeedsStart || preview.windowCapped)
