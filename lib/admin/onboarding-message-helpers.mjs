...
export function buildOnboardingWelcomeMessage({
  ...
  if (isAdult) {
    return `Hey ${recipientFirstName}, we've got you down for ${lessonTime} on ${lessonDay} ${lessonDate} with ${tutorFirstName}. ✨🎶
...
School Handbook 📖: ${handbookUrl}`;
  ...
  return `Hey ${recipientFirstName}, we've got ${learnerLabel} down for ${lessonTime} on ${lessonDay} ${lessonDate} with ${tutorFirstName}. ✨🎶
